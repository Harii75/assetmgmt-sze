...
const YearlySoftwareChart = () => {
  ...
  return (
    <div className="bg-white shadow-md rounded-lg m-6 mb-10 p-6 flex flex-col items-center">
      <h2 className="text-2xl font-semibold text-center text-gray-800 pb-3">
        Évente beszerzett szoftverek és licenszek
      </h2>
      ...
      {!loading && !error && (
        <div className="w-full flex justify-center">
          <div className="w-[99%] h-[300px] pr-8">
